  ...
  return (
    <EmailLayout preview="Welcome to cors.sh">
      ...
      <Text style={styles.text}>
        Thanks for signing up. cors.sh is a CORS proxy that lets your frontend call any API without
        &ldquo;blocked by CORS policy&rdquo; errors — no backend required.
      </Text>
      ...
      <Text style={styles.text}>
        ...
        <br />
        2. Point requests at <code>https://proxy.cors.sh/&lt;target-url&gt;</code> with your key in
        the <code>x-cors-api-key</code> header.
        <br />
